...
export default async function BloqueoCajaPage() {
  ...
  return (
    <div className="flex flex-col gap-8 p-6">
      {/* Al exportar el listado de diferencias (DiferenciasBloqueoCajaTable dispara
          window.print()) solo tiene que imprimirse la tabla, no el título ni la configuración. */}
