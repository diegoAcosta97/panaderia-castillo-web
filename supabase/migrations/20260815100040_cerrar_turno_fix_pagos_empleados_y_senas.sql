-- Corrige una regresión introducida en 20260815100030_cerrar_turno_incluye_senas.sql: esa
-- migración se escribió a partir de una versión de cerrar_turno anterior a
-- 20260810100010_pagos_empleados_en_cierre_turno.sql y perdió la resta de v_pagos_empleados.
-- Esta versión trae ambos términos: pagos a empleados (resta) y señas de pedidos por encargo
-- (suma).
